#!/usr/bin/env python3
"Extract translatable strings from the .json files in gamedata/data/json."
...
# there may be some non-json files in gamedata/data/raw
...
warning_suppressed_list = {os.path.normpath(i) for i in {
    "gamedata/data/json/overmap_terrain.json",
    "gamedata/data/json/traps.json",
    "gamedata/data/json/vehicleparts/",
    "gamedata/data/raw/keybindings.json",
    "gamedata/data/mods/alt_map_key/overmap_terrain.json",
    "gamedata/data/mods/DeoxyMod/Deoxy_vehicle_parts.json",
    "gamedata/data/mods/More_Survival_Tools/start_locations.json",
    "gamedata/data/mods/NPC_Traits/npc_classes.json",
    "gamedata/data/mods/Tanks/monsters.json"
}}
...
ignore_files = {os.path.normpath(i) for i in {
    "gamedata/data/json/anatomy.json",
    "gamedata/data/mods/replacements.json",
    "gamedata/data/raw/color_templates/no_bright_background.json"
}}
...
def extract_material(item):
    ...
    if not wrote and not "copy-from" in item :
        print("WARNING: {}: no mandatory field in item: {}".format("/gamedata/data/json/materials.json", item))
...
directories = {os.path.normpath(i) for i in {
    ...
    "gamedata/data/mods",
    "gamedata/data/core",
    "gamedata/data/legacy",
    "gamedata/data/help",
}}
to_dir = os.path.normpath("gamedata/lang/json")

print("==> Preparing the work space")

# allow running from main directory, or from script subdirectory
if not os.path.exists("gamedata/data/json"):
    print("Error: Couldn't find the 'gamedata/data/json' subdirectory.")
    exit(1)
